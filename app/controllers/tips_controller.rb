class TipsController < ApplicationController
	...
	def index
		...
		@tips = logged_in ? current_user.tips : []
		respond_to do |format|
			format.html
			format.js{@tips = current_user.tips; render '/shared/ajax_race'}
		end
	end
	...
	def destroy
		...
		@tip.destroy if !@tip.past_cutoff_time? && !@tip.sent?
		respond_to do |format|
			format.html
			format.js{@tips = current_user.tips; render '/shared/ajax_tips_race'}
		end
	end
